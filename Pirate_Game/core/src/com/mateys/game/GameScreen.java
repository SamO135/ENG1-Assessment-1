...
public class GameScreen extends ScreenAdapter {
	...
	public void show() {
		...
		FreeTypeFontGenerator fontGenerator = new FreeTypeFontGenerator(Gdx.files.internal("BlackSamsGold.ttf"));
	...
	public void render (float delta) {
		...
		for (Rectangle rect : rects) {
			if (player.getPlayerRect().overlaps(rect)) {
				player.position.mulAdd(player.movement.nor(), -(PlayerShip.MOVE_SPEED) * Gdx.graphics.getDeltaTime());
			}
		}
